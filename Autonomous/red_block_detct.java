// This is our code to detect the skystone blocks.
...
@TeleOp(name="CompletekjasdfInv", group ="CompletaksjdfeInv2")
@Disabled
public class BlockRed extends LinearOpMode {
   ...
   private static final String VUFORIA_KEY =
           "";
   ...
   @Override public void runOpMode() {
       ...
       strafeLeft(-0.75,0.75,0.75,-0.75, 1700); //1200// 800
       stop(100);
// strafeLeft 1000
       ...
       while (!targetVisible) {
           ...
           for (VuforiaTrackable trackable : allTrackables) {
               ...
               if (((VuforiaTrackableDefaultListener)trackable.getListener()).isVisible()) {
                   ...
                   right(0.5, 0.5, -0.5,-0.5, 2500);//2400 // 2650 (2nd time) // 2750 final
                   //2900
                   stop (250);
                   ...
                   vacuum2.setPosition(180);
                   stop(1000); // 1000
                   backward(0.5, 2050); //2300 originally
                   stop(100);//500
                   right(0.5, 0.5, -0.5,-0.5, 1350);//1300 // 1225 // 1350 final
                   forward(-1.0, 3050); //2300
                   vacuum1.setPosition(0.5);
                   vacuum2.setPosition(0.5);
                   backward(1.0,1850); // 1400
                   setFlashlightEnabled(false);

                   left(-0.5,-0.5,0.5,0.5,1200);//1250 //1150
                   vacuum1.setPosition(-0.5);
                   forward (-0.5, 1000);
                   stop(500); //500
                   vacuum1.setPosition(-180);
                   ...
                   vacuum2.setPosition(180);
                   stop(1000);//1000
                   backward(0.5, 1850); //2300 originally
                   stop(100); // 500
                   right(0.5, 0.5, -0.5,-0.5, 1300);//1300 //1300
                   forward(-1.0, 1650);//1500
                   vacuum1.setPosition(0.5);
                   vacuum2.setPosition(0.5);
                   backward(0.5, 200); //2300 originally //50
                   stop (100);
                   ...
                   strafeLeft (0.25, -0.25, -0.25, 0.25, 100); // strafeleft until block is detected
   ...
   public void strafeRight(double power1, double power2, double power3, double power4, long time)
   {
       move(power1, power2, power3, power4, time);
   }
