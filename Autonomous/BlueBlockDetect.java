...
@TeleOp(name="BlockBlue1", group ="BlockBlue2")
@Disabled
public class BlockBlue extends LinearOpMode {
   ...
   @Override public void runOpMode() {
       ...
       tapeM=hardwareMap.get(Servo.class, "tapeMServo");
